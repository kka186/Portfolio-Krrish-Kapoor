...
def servo_init():
    ...
    # /.....enter code here...../
    Board.setPWMServoPulse(1, 1700, 1000)
    Board.setPWMServoPulse(3, 2500, 1000)
    Board.setPWMServoPulse(4, 900,  1000)
    Board.setPWMServoPulse(5, 700,  1000)
    ...
    while True:
        ...
        if __isRunning:
            if line_centerx != -1 and not obstacle:
                ...
                speed=40
                Board.setMotor(1, int(speed + base_speed))
        ...
        for i in lab_data:
            if i in __target_color:
                ...
                frame_mask = cv2.inRange(frame_lab,
                             ...
                             (lab_data[i]['max'][0],
                              lab_data[i]['max'][1],
                              lab_data[i]['max'][2]))  #Perform bitwise operations on the original image
